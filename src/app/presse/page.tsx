...
const pressItems = [
  {
    ...
    type: "Fernsehen",
    date: "7. Juni 2026",
    badge: "Beitrag ansehen",
    live: false,
    title: "Butlery in Tirol heute (ORF)",
    excerpt: "Im Regionalmagazin Tirol heute berichtet der ORF über Butlery — die KI-Reservierungsplattform aus dem Defereggental und ihren jungen Gründer Michael Kleinlercher.",
    url: "https://on.orf.at/video/14326374/tirol-heute-vom-07062026",
    cta: "Beitrag in der ORF-TVthek ansehen",
    accent: "#FF5C35",
  },
  {
  ...
  },
  {
    ...
    badge: "Online lesen",
    live: false,
    title: "Reservierungen besser im Blick",
    excerpt: "top.tirol berichtet über Butlery und wie die Reservierungsplattform Restaurants dabei hilft, Anrufe, WhatsApp-Anfragen und Online-Buchungen an einem Ort zu bündeln.",
    url: "https://top.tirol/news/reservierungen-besser-im-blick",
    cta: "Artikel auf top.tirol lesen",
    accent: "#1A1A2E",
  },
];
  ...
  return (
    <>
      ...
      <nav style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"14px 32px",position:"sticky",top:0,background:"rgba(255,250,245,0.97)",backdropFilter:"blur(16px)",zIndex:100,borderBottom:"1px solid var(--border)"}}>
        <a href="/" style={{textDecoration:"none",fontFamily:"var(--font-playfair),Georgia,serif",fontSize:"22px",fontWeight:700,color:"var(--dark)"}}><img src="/butlery-logo-dunkel.png" alt="Butlery" style={{height:"24px",width:"auto",display:"inline-block",verticalAlign:"middle"}}/></a>
      ...
      <section style={{background:"var(--dark)",padding:"80px 32px 90px",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{maxWidth:"800px",margin:"0 auto",textAlign:"center",position:"relative",zIndex:1}}>
          ...
          <h1 style={{fontFamily:"var(--font-playfair),Georgia,serif",fontSize:"clamp(34px,5vw,52px)",fontWeight:700,color:"#FFFAF5",letterSpacing:"-1.5px",lineHeight:1.05,marginBottom:"20px"}}>
            Butlery in den <span style={{color:"#FF5C35",fontStyle:"italic"}}>Medien.</span>
          </h1>
          <p style={{color:"rgba(255,255,255,.55)",fontSize:"17px",lineHeight:1.7,fontWeight:300,maxWidth:"560px",margin:"0 auto"}}>
            Was über Butlery und Gründer Michael Kleinlercher berichtet wird — von der Tiroler Tageszeitung bis zum ORF.
          </p>
        </div>
      </section>
      ...
      <section style={{background:"var(--cream)",padding:"70px 32px 90px"}}>
          ...
          {pressItems.map((item,i)=>(
            <div key={i} className="press-card" style={{
              ...
              <div className="press-card-side" style={{
                ...
                <div style={{fontFamily:"var(--font-playfair),Georgia,serif",fontSize:"22px",fontWeight:700,color:item.live?"#FFFAF5":"var(--dark)",lineHeight:1.2,marginBottom:"10px"}}>{item.outlet}</div>
              ...
              <div style={{flex:1,padding:"28px",display:"flex",flexDirection:"column"}}>
                ...
                <h2 style={{fontFamily:"var(--font-playfair),Georgia,serif",fontSize:"20px",fontWeight:700,color:"var(--dark)",lineHeight:1.3,letterSpacing:"-0.3px",marginBottom:"12px"}}>{item.title}</h2>
        ...
        <div style={{maxWidth:"880px",margin:"40px auto 0",background:"var(--dark)",borderRadius:"20px",padding:"36px 40px",textAlign:"center"}}>
          ...
          <h3 style={{fontFamily:"var(--font-playfair),Georgia,serif",fontSize:"24px",fontWeight:700,color:"#FFFAF5",letterSpacing:"-0.5px",marginBottom:"12px"}}>Über Butlery berichten?</h3>
          ...
          <a href="mailto:michael@tablely.at?subject=Presseanfrage Butlery" style={{display:"inline-flex",alignItems:"center",gap:"8px",background:"#FF5C35",color:"#fff",padding:"13px 28px",borderRadius:"10px",fontSize:"15px",fontWeight:600,textDecoration:"none"}}>
            michael@tablely.at
          </a>
        </div>
      </section>
      ...
      <footer style={{padding:"24px 32px",borderTop:"1px solid var(--border)",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:"12px"}}>
        <a href="/" style={{textDecoration:"none",fontFamily:"var(--font-playfair),Georgia,serif",fontSize:"18px",fontWeight:700,color:"var(--dark)"}}><img src="/butlery-logo-dunkel.png" alt="Butlery" style={{height:"24px",width:"auto",display:"inline-block",verticalAlign:"middle"}}/></a>
        ...
        <p style={{fontSize:"12px",color:"var(--muted)"}}>© 2026 Butlery · Michael Kleinlercher e.U.</p>
      </footer>
    </>
  );
}