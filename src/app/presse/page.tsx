...
const pressItems = [
  {
    ...
    live: false,
    title: "Tablely in Tirol heute (ORF)",
    excerpt: "Im Regionalmagazin Tirol heute berichtet der ORF über Tablely — die KI-Reservierungsplattform aus dem Defereggental und ihren jungen Gründer Michael Kleinlercher.",
  ...
  },
  {
    ...
    excerpt: "top.tirol berichtet über Tablely und wie die Reservierungsplattform Restaurants dabei hilft, Anrufe, WhatsApp-Anfragen und Online-Buchungen an einem Ort zu bündeln.",
