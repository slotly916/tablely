        ...
        <div style={{maxWidth:"1200px",margin:"0 auto",padding:"80px 32px 0",display:"grid",gridTemplateColumns:"1fr 1fr",gap:"80px",alignItems:"flex-end"}}>
          ...
          <div style={{paddingBottom:"80px"}}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:"16px",flexWrap:"wrap"}}>
              ...
              <span style={{fontSize:"13px",color:"rgba(255,255,255,.3)"}}>Kostenlos · Kein Kreditkarte</span>
            </div>
          </div>

          {/* Right — Dashboard Mockup im Browser */}
      ...
      <section style={{background:"var(--cream)",padding:"100px 32px"}}>
        <div style={{maxWidth:"1100px",margin:"0 auto",display:"grid",gridTemplateColumns:"1fr 1fr",gap:"80px",alignItems:"center"}}>
          ...
          <div>
            ...
            <h2 style={{fontFamily:"'Playfair Display',serif",fontSize:"40px",fontWeight:700,letterSpacing:"-1px",lineHeight:1.1,marginBottom:"20px"}}>
              Das Reservierungsbuch kostet dich täglich Geld.
            </h2>
            <p style={{color:"var(--muted)",fontSize:"16px",lineHeight:1.8,fontWeight:300,marginBottom:"16px"}}>
              Jeder Anruf während der Stoßzeit ist eine Ablenkung. Jede Minute im Buch blättern ist verschwendete Zeit. Jeder No-Show ohne Erinnerung ist bares Geld.
            </p>
            <p style={{color:"var(--muted)",fontSize:"16px",lineHeight:1.8,fontWeight:300}}>
              Österreichische Restaurants verlieren täglich bis zu <strong style={{color:"var(--dark)"}}>2 Stunden</strong> durch manuelle Reservierungen. Tablely gibt dir diese Zeit zurück.
            </p>
          </div>
        </div>
      </section>
