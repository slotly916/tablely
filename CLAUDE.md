...
- src/app/api/whatsapp/route.ts — WhatsApp-KI (Slot-Filling, Alternativzeiten wenn voll, LARGE_GROUP ab 15 Personen → pending, CANCEL_RESERVATION → Storno, KI-Kennzeichnung in erster Nachricht)
